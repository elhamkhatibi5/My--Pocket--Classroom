      ...
      <div class="card mb-3 p-2 shadow-sm">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between flex-wrap">
            <button class="btn btn-success btn-sm mb-1 learnBtn">Learn</button>
            <button class="btn btn-warning btn-sm mb-1 editBtn">Edit</button>
            <button class="btn btn-info btn-sm mb-1 exportBtn">Export</button>
            <button class="btn btn-danger btn-sm mb-1 deleteBtn">Delete</button>
          </div>
        </div>
      </div>
    `;
...
function openEdit(id){
  ...
  document.getElementById('titleInput').value = capsule.title;
  document.getElementById('subjectInput').value = capsule.subject;
  document.getElementById('levelInput').value =addFlashcardBtn.addEventListener('click', ()=>{
  const div=document.createElement('div');
  div.className='mb-2';
  div.innerHTML=`
    <input type="text" placeholder="Front" class="form-control mb-1 frontInput">
